...
namespace LB_1.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            //return View(players);
            return RedirectToAction("Index", "GameLists", new { field = "Player", players.Id });
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Login,StartCapital,Birth")] Players players)
        {
            if (id != players.Id)
            {
                return NotFound();
